...
from warp_api import WarpAPI, AsyncWarpAPI, APIResponseValidationError
from warp_api._types import Omit
from warp_api._utils import asyncify
from warp_api._models import BaseModel, FinalRequestOptions
from warp_api._exceptions import WarpAPIError, APIStatusError, APITimeoutError, APIResponseValidationError
from warp_api._base_client import (
    DEFAULT_TIMEOUT,
...
class TestWarpAPI:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "warp_api/_legacy_response.py",
                        "warp_api/_response.py",
    ...
    @mock.patch("warp_api._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
